...
structure HiddenDerivativeConstruction {n q k A : ℕ} (d m : ℕ)
...
theorem HiddenDerivativeConstruction.specializes_to_zero
...
def UniformHiddenDerivativeConstructionStatement : Prop :=
